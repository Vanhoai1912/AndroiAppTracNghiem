        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              final deleted = await AppDatabase.deleteUserByEmail(email);
              print("Đã xoá $deleted dòng từ bảng users");

              await AppDatabase.printAllUsers();
